...
require dirname(dirname(__DIR__)).'/obs-autoloader.php';
require dirname(dirname(__DIR__)).'/Init.php';
require dirname(dirname(__DIR__)).'/vod/model/InitiateMultipartUploadReq.php';
require dirname(dirname(__DIR__)).'/vod/model/MultipartUploadReq.php';
require dirname(dirname(__DIR__)).'/vod/model/ListPartsReq.php';
require dirname(dirname(__DIR__)).'/vod/model/CompleteMultipartUploadReq.php';
require dirname(dirname(__DIR__)).'/vod/service/UploadService.php';
...
class ConcurrentUploadPart{
     ...
     */
    public static function upload($bucketName,$objectKey,$filePath)
    {
        ...
        try
        {
            ...
            $initiateReq->setContentType(Psr7\mimetype_from_filename($objectKey));
            $initiateReq->setObjectKey($objectKey);
            $initiateReq->setBucket($bucketName);
            $initiateRsp = UploadService::InitiateMultipartUpload($initiateReq);
            ...
            for($i = 0; $i < $partCount; $i++){
                ...
                $uploadRsp = UploadService::MultipartUpload($uploadReq);
            ...
            $listPartsRsp = UploadService::ListParts($listPartsReq);
            ...
            $completeUploadPartsRsp= UploadService::CompleteMultipartUpload($completeUploadPartsReq);
