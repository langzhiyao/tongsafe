<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/home/www/chenganxjh/public/../application/admin/view/teachvideo/edit.html";i:1558338271;s:72:"/home/www/chenganxjh/public/../application/admin/view/public/header.html";i:1558338271;s:77:"/home/www/chenganxjh/public/../application/admin/view/public/admin_items.html";i:1558338271;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script>
    ...
    function uploadFile(){
        ...
        //ajax.open("POST", "http://www.chenganxjh.com/index.php/Admin/Teachvideo/video_data");
...
<?php endif; ?>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li>只可修改视频信息，如需修改视频，请重新上传。</li>
            <li>视频封面图不传的话，默认不修改。</li>
        </ul>
    </div>
    <br>
    <form id="user_form" enctype="multipart/form-data" method="post">
        ...
        <table class="ds-default-table">
            <tbody>
            <input type="hidden" name="t_id" value="<?php echo $video_info['t_id']; ?>" id="t_id">
            <input type="hidden" name="path" value="<?php echo $video_info['t_url']; ?>" id="path">
            <input type="hidden" name="pic" value="<?php echo $video_info['t_videoimg']; ?>" id="pic">
            <input type="hidden" name="time" value="<?php echo $video_info['t_timelength']; ?>" id="time">
            <tr>
                <td colspan="2" class="required"><label for="video_file"><?php echo \think\Lang::get('teacher_index_videoimgfirst'); ?>:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform">
                    <input type="file" name="video_filename" id="video_filename" value="" />
                </td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" value="<?php echo $video_info['t_author']; ?>" id="video_author" name="video_author" class="txt"></td>
                <td class="vatop tips"></td>
            </tr>
            <tr>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" value="<?php echo $video_info['t_price']; ?>" id="video_price" name="video_price" class="txt"></td>
                <td class="vatop tips"></td>
            </tr>
                <tr class="noborder">
                ...
                <tr class="noborder">
                    <td class="vatop rowform"><input type="text" value="<?php echo $video_info['t_title']; ?>" name="video_name" id="video_name" class="txt"></td>
                    <td class="vatop tips"></td>
                </tr>
                <tr class="noborder">
                ...
                <tr class="noborder">
                    <td id="video_type"> <select name="type1" lay-verify="type1" class="select" onchange="fand_type2($(this))">
                        ...
                        <option value="<?php echo $type['gc_id']; ?>" <?php if($video_info['t_type'] == $type['gc_id']): ?>selected='selected'<?php endif; ?>><?php echo $type['gc_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                        ...
                        <option value="<?php echo $type['gc_id']; ?>" <?php if($video_info['t_type2'] == $type['gc_id']): ?>selected='selected'<?php endif; ?>><?php echo $type['gc_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; } ?>
                    </select>
                        <select id="type3_list" name="type3" lay-verify="type" class="select" onchange="fand_type4($(this))">
                            ...
                            <option value="<?php echo $type['gc_id']; ?>" <?php if($video_info['t_type3'] == $type['gc_id']): ?>selected='selected'<?php endif; ?>><?php echo $type['gc_name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; } ?>
                        </select>
                        <select id="type4_list" name="type4" lay-verify="type" class="select">
                            ...
                            <option value="<?php echo $type['gc_id']; ?>" <?php if($video_info['t_type4'] == $type['gc_id']): ?>selected='selected'<?php endif; ?>><?php echo $type['gc_name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; } ?>
                        </select></td>
                    <td class="vatop tips"></td>
                </tr>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" value="<?php echo $video_info['t_profile']; ?>" id="t_profile" name="t_profile" class="txt"></td>
                <td class="vatop tips"></td>
            </tr>
                <tr>
                ...
                <tr class="noborder">
                    <td class="vatop rowform"><input type="text" value="<?php echo $video_info['t_desc']; ?>" id="video_desc" name="video_desc" class="txt"></td>
                    <td class="vatop tips"></td>
                </tr>
